...
# Configure OpenTelemetry exporter if not in test mode and telemetry is enabled
if not os.getenv("TEST_MODE") and not os.getenv("DISABLE_TELEMETRY"):
    from opentelemetry.exporter.otlp.proto.grpc.trace_exporter import OTLPSpanExporter
    ...
    logger.info("OpenTelemetry exporter disabled")

# Import evaluators and routers
from evaluators import f1_evaluator
