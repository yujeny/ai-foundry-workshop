...
class MedicationChatHandler(AgentEventHandler):
    """Event handler for streaming medication analysis responses."""
    
    def __init__(self):
        super().__init__()
        self.current_run_status = None
        
    def on_message_delta(self, delta: MessageDeltaChunk) -> Generator[str, Any, Any]:
    ...
    def on_thread_message(self, message: ThreadMessage) -> Generator[str, Any, Any]:
    ...
    def on_error(self, data: str) -> Generator[str, Any, Any]:
        """Handle error events."""
        error_msg = f"Error in medication analysis: {data}"
    ...
    def on_done(self) -> Generator[str, Any, Any]:
        """Handle stream completion."""
        logger.info("Medication analysis stream completed")
